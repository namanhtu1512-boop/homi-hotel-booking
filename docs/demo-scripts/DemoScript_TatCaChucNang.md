...
## PHẦN 5 — Kiểm thử tự động

```bash
php artisan test
```

612/612 test pass tại thời điểm viết tài liệu này — bao gồm toàn bộ 8 tính
năng mới (room hold, giá theo mùa, khuyến mãi stack, dịch vụ, bản đồ, hóa
đơn, đặt đoàn, lễ tân/buồng phòng) cộng với toàn bộ tính năng cũ.
