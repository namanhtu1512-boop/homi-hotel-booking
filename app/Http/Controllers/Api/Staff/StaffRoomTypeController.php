...
/**
 * Quản lý loại phòng dành cho staff — cùng quyền hạn với
 * AdminRoomTypeController ngoại trừ forceDelete (xem RoomTypePolicy: admin
 * toàn quyền kể cả forceDelete, staff xem/thêm/sửa/xóa mềm/khôi phục/đổi
 * giá/số lượng — forceDelete không được expose qua route nào). Namespace
 * riêng chỉ để tách luồng API admin/staff.
 */
