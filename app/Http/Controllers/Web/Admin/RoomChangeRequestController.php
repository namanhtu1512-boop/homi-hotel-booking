...
class RoomChangeRequestController extends Controller
{
    ...
    {
        return view('admin.room-change-requests.index', [
    ...
    public function show(int $id): View
    {
        ...
        return view('admin.room-change-requests.show', ['roomChangeRequest' => $roomChangeRequest]);
    }
    ...
    public function approve(int $id, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.room-change-requests.show', $id)->with('success', 'Đã duyệt yêu cầu đổi phòng.');
    }
    ...
    public function reject(int $id, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.room-change-requests.show', $id)->with('success', 'Đã từ chối yêu cầu đổi phòng.');
    }
}
