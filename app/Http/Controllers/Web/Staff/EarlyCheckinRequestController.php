...
class EarlyCheckinRequestController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('staff.early-checkin-requests.index', [
    ...
    public function show(int $id): View
    {
        ...
        return view('staff.early-checkin-requests.show', ['earlyCheckinRequest' => $earlyCheckinRequest]);
    }
    ...
    public function approve(int $id, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('staff.early-checkin-requests.show', $id)->with('success', 'Đã duyệt yêu cầu nhận phòng sớm.');
    }
