...
/**
 * Dùng cho LateCheckoutRequest — có cột JSON `room_selections` (map
 * booking_item_id => số lượng phòng của dòng đó khách chọn, VD {"92": 1,
 * "93": 1} — chỉ 1/2 phòng Standard của dòng 92) + quan hệ booking() trả về
 * Booking có bookingItems. null/rỗng = áp dụng cho TOÀN BỘ phòng trong đơn
 * (tương thích ngược với các yêu cầu tạo trước khi có tính năng chọn phòng
 * theo số lượng).
 *
