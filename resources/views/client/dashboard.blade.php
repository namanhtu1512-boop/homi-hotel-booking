        ...
        <div class="card">
            ...
            <div class="quick-actions">
                @if (in_array(auth()->user()->role, ['admin', 'staff']))
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-primary">Trang quản trị</a>
                    <a href="{{ route('admin.hotel-info.show') }}" class="btn btn-outline">Thông tin khách sạn</a>
                    <a href="{{ route('admin.room-types.index') }}" class="btn btn-outline">Quản lý loại phòng</a>
