...
@section('title', 'Yêu cầu giường phụ #' . $extraBedRequest->id . ' · Homi Admin')
...
<div class="card">
    ...
    <div class="info-list mt-4">
        <div class="info-item">
            ...
            <span class="value"><a href="{{ route('admin.bookings.show', $extraBedRequest->booking_id) }}">{{ $extraBedRequest->booking->booking_code }}</a></span>
        </div>
        <div class="info-item">
    ...
    @if ($extraBedRequest->status === 'pending')
        <div class="mt-5">
            ...
            <div class="quick-actions-row mt-2">
                <form method="POST" action="{{ route('admin.extra-bed-requests.resolve', $extraBedRequest->id) }}" class="flex items-center gap-2">
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.extra-bed-requests.resolve', $extraBedRequest->id) }}">
                    @csrf
