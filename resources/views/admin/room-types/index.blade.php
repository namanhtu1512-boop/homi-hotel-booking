...
<div class="card">
    ...
    <form method="GET" action="{{ route('admin.room-types.index') }}" class="filter-bar mb-4">
        <div>
        ...
        @if ($dateRangeApplied)
            <a href="{{ route('admin.room-types.index') }}" class="btn btn-outline">Xóa lọc</a>
        @endif
    </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-row">
                                    <a href="{{ route('admin.room-types.show', $room->id) }}" class="btn btn-outline btn-sm">Xem</a>
