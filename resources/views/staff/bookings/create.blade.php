...
@section('title', 'Đặt phòng tại quầy · Homi Nhân viên')
...
<div class="card mx-auto max-w-2xl">
    <form method="POST" action="{{ route('staff.bookings.store') }}" class="space-y-4">
        @csrf
        ...
        <div class="action-row">
            ...
            <a href="{{ route('staff.bookings.index') }}" class="btn btn-outline">Hủy</a>
        </div>
    </form>
</div>
