...
<body class="bg-slate-50 font-sans text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    <div class="flex min-h-screen flex-col md:flex-row">
        <aside class="flex shrink-0 flex-col gap-1 overflow-y-auto bg-slate-950 p-4 text-slate-300 md:sticky md:top-0 md:h-screen md:w-64 md:p-5">
            ...
            <nav class="flex flex-row flex-wrap gap-1 md:flex-col md:flex-nowrap">
                @php
                    $adminLinks = [
                        ...
                        ['route' => 'admin.rooms.index', 'pattern' => ['admin.rooms.index', 'admin.rooms.create', 'admin.rooms.edit'], 'label' => 'Phòng vật lý'],
                        ['route' => 'admin.rooms.calendar', 'pattern' => 'admin.rooms.calendar', 'label' => 'Lịch phòng'],
                        ...
                        ['route' => 'admin.promotions.index', 'pattern' => 'admin.promotions.*', 'label' => 'Khuyến mãi', 'badge' => $promotionRequestNewCount ?? 0],
                        ...
                        ['route' => 'admin.extra-bed-requests.index', 'pattern' => 'admin.extra-bed-requests.*', 'label' => 'Yêu cầu giường phụ', 'badge' => $extraBedNewCount ?? 0],
