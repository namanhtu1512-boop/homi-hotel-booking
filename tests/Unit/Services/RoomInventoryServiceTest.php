 ...
 * TC-INV-003   | Tổng phòng chỉ tính phòng active            | Không cộng phòng hidden
...
class RoomInventoryServiceTest extends TestCase
{
    ...
    public function test_total_rooms_excludes_inactive_room_types(): void
    {
        ...
        $total = $this->service->getTotalRooms();
